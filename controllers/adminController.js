...
module.exports = {
    viewSignin: async(req, res) => {
        try {
            ...
            if (req.session.user == null || req.session.user == undefined) {
                res.render('index', { alert, title: "Staycation | Sign In" });
            } else {
    ...
    deleteItem: async(req, res) => {
        try {
            ...
            await item.remove();
            const feature = await Feature.findOne({ itemId: id });
    ...
    addFeature: async(req, res) => {
        ...
        try {
            ...
            const feature = await Feature.create({ name, qty, imageUrl: `images/${req.file.filename}`, itemId });
    ...
    addActivity: async(req, res) => {
        ...
        try {
            ...
            const activity = await Activity.create({ name, type, imageUrl: `images/${req.file.filename}`, itemId });
            const item = await Item.findOne({ _id: itemId });
    ...
    acceptBooking: async(req, res) => {
        ...
        try {
            ...
            await booking.save();
            req.flash('alertMessage', 'Success Accept Pembayaran');
            req.flash('alertStatus', 'success');
